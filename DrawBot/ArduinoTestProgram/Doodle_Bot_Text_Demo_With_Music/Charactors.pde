...
void Heart()
{
  Go(3);Turn(-135);Down();Go(4);Turn(45);Go(2);Turn(45);Go(1);Turn(45);Go(1);Turn(45);Go(1);Turn(-90);Go(1);Turn(45);Go(1);Turn(45);Go(1);Turn(45);Go(2);Turn(45);Go(4);Up();Turn(-135);Go(5);
}
